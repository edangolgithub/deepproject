...
namespace dotnetserverless
{
    public class SqlServer: DbContext
    {
        ...
        {
               optionsBuilder
               .UseSqlServer("workstation id=sqlserver.mssql.somee.com;packet size=4096;user id=edangol_SQLLogin_1;pwd=qpnpz5zqqj;data source=sqlserver.mssql.somee.com;persist security info=False;initial catalog=sqlserver");
        }
